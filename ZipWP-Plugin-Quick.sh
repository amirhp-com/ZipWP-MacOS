 ...
 * @Last modified time: 2024/08/04 14:49:50
 */
'
...
zip -r "$folder-v$version.zip" "$folder_name" -x ".git*" -x ".vscode*" -x ".DS_Store" -x ".VSCodeCounter" -x "index.html" -x "index.php" -x "jsconfig.json"
